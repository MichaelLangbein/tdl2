...
describe("Top-down variable structure", () => {
    ...
    test("basics", () => {
        ...
        const tree: TaskTree = {
            id: 0,
            parent: null,
            created: 1, completed: null, lastUpdate: 1, secondsActive: 100, deadline: null,
            attachments: [], description: "", title: "",
            children: [{
                id: 1,
                parent: 0, 
                created: 1, completed: 1, lastUpdate: 1, deadline: null,
                secondsActive: 75,
                children: [],
                attachments: [], description: "", title: "",
            }, {
                id: 2,
                parent: 0,
                created: 1, completed: null, lastUpdate: 1, deadline: null,
                secondsActive: 60,
                description: "", title: "",
                attachments: [],
                children: [{
