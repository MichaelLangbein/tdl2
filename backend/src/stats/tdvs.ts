...
function estimate(node: LeveledTaskTree, timesOnLevels: levelTimeDists, childrenOnLevels: levelChildDists): number {
    ...
    const fakeChild: LeveledTaskTree = {id: -99999, level: node.level + 1, secondsActive: 0, children: [], title: "", description: "", attachments: [], parent: node.id, created: 1, lastUpdate: 1, completed: null, deleted: null, deadline: null};
